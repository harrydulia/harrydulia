<div align="center">
  ...
  <!-- 圓形大頭照，直接抓取 GitHub 預設頭像 -->
  <a href="https://github.com/harrydulia">
    <img src="https://github.com/harrydulia.png" width="150" height="150" alt="Harry's Avatar" style="border-radius: 50%; border: 4px solid #58A6FF;" />
  </a>
  ...
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=20&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=500&lines=軟體開發者+(Software+Developer);資料科學愛好者+(Data+Science);量化金融研究+(Quantitative+Finance)" alt="Typing SVG" />
  </a>
...
- 🔭 喜歡透過**Vibe coding**開發實用的 Web 應用程式，例如 **濾心更換紀錄系統、個人體重紀錄系統**，使用 Python、Flask/FastAPI 與 PWA 技術。
- 👨‍💻 活躍於 **Python** 開發，經常撰寫與除錯腳本。擅長使用 **Pandas** 處理資料，以及使用 **Gurobi** 進行複雜的數學最佳化。
- 🎓 畢業於**臺北商業大學資訊管理系碩士班**，研究領域深入探討**穩健投資組合最佳化**，並曾在維也納的 IFORS 2026 學術研討會發表研究成果。
- 👨‍🏫 曾擔任大學部**資料庫管理**課程的教學助理。
- ⚡ **有趣的事實：** 當我不在寫 Python時，你可能會發現我正在規劃 10k 的河岸夜跑路線或是正在盯著股票看！
...
<p align="center">
  ...
  <a href="https://www.gurobi.com/" target="_blank" rel="noreferrer"> <img src="https://img.shields.io/badge/Gurobi-ED2124?style=for-the-badge&logo=gurobi&logoColor=white" alt="gurobi"/> </a>
</p>
